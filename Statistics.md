...
Power of 2 means only one bit of n is '1', so use the trick n&(n-1)==0 (231). Boyer-Moore Voting Algorithm (169). (num&(num-1)) == 0 && (num & 0x55555555) - Power of 4(342).
